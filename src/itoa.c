/*
    ...
    For itoa if base is 10 and value is negative, the resulting string is preceded
...
/* utoac:  convert unsigned n to characters in s for base base
 ...
 */
char * utoac ( unsigned int n, char * s, unsigned int base, int uppercase)
{
    int i;
 ...
 * Based on Karnighan & Ritchie code
 */
char * itoac ( int n, char * s, unsigned int base, int uppercase)
{
    char* ss = s;
    if(10 == base && n < 0)
    {
    ...
    utoac((unsigned int) n, s, base, uppercase);
